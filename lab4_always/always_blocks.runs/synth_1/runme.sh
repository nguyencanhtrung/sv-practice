...
HD_PWD='/home/tesla/workspace/05.Soc/10.studies/08.sv/lab4_always/always_blocks.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log security_sv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source security_sv.tcl
