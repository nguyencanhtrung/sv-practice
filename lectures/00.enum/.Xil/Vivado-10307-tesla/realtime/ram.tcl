...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-10307-tesla/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog -sv /home/tesla/workspace/05.Soc/10.studies/08.sv/lectures/04.packages/src/functions.sv
      rt::filesetChecksum
    }
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-10307-tesla/"
